...
function interfaceDeclarationForOperation(generator, _ref3) {
  ...
  (0, _language.interfaceDeclaration)(generator, {
    interfaceName: interfaceName,
    extendTypes: fragmentSpreads ? fragmentSpreads.map(f => `${(0, _changeCase.pascalCase)(f)}`) : null
  }, () => {
...
function interfaceDeclarationForFragment(generator, _ref4) {
  ...
  const interfaceName = `${(0, _changeCase.pascalCase)(fragmentName)}`;
  ...
  (0, _language.interfaceDeclaration)(generator, {
    ...
    const properties = uniqWith((_propertiesFromFields = propertiesFromFields(generator.context, fields)).concat.apply(_propertiesFromFields, (0, _toConsumableArray3.default)((inlineFragments || []).map(fragment => propertiesFromFields(generator.context, fragment.fields, true)))), (p1, p2) => {
